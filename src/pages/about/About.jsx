          ...
          <div className='md:w-1/2 md:border-x-2 border-black '>
            <div className='p-10 md:p-20'>
              ...
              <p className='mb-2 text-lg'>
                As a web developer, I am fascinated by the potential of websites
                to showcase work and ideas to a global audience. Websites offer
                a dynamic platform that is both lightweight and flexible,
                providing endless possibilities for creativity and innovation.
              </p>
              <p className='mb-4 text-lg'>
                I am confident in my ability to contribute to your development
                team. If you are seeking a highly motivated and driven
                individual, I would be honored to have the opportunity to work
                with you.
              </p>
          ...
          <div className='w-full md:w-1/2 flex justify-start items-center flex-col '>
            ...
            <div className='w-full flex flex-col justify-evenly items-center '>
              ...
              <div className='w-full  text-2xl  border-black p-5 '>
                ...
                <div className='w-full text-6xl flex flex-wrap gap-5 mt-3'>
                  <i className='devicon-laravel-original-wordmark colored text-7xl'></i>

                  <i className='devicon-react-original-wordmark colored'></i>

                  <i className='devicon-vuejs-plain-wordmark colored'></i>

                  <i className='devicon-nuxtjs-plain-wordmark colored'></i>
