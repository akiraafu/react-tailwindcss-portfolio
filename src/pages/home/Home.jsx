      ...
      <section className='h-full'>
        <div className='w-full h-full mx-auto flex flex-col md:flex-row items-center'>
          ...
          <div className='w-full md:w-1/2 h-full p-10 md:p-20 '>
            <h2 className='text-lg md:text-xl font-bold'>Hi, 👋</h2>
            <h1
              className='text-4xl lg:text-5xl xl:text-7xl font-bold mb-4
            '
            >
              I'm Akira<span className='text-yellow-400'>.</span>
              <br />
              Web Developer<span className='text-violet-900'>.</span>
            </h1>
            <p className='text-lg max-w-xl mb-6 text-justify'>
              As a passionate and driven developer with background in IT and
              Marketing, I am fascinated by the endless possibilities of web
              development and how it can boost business. Committed to continuous
              learning and development, aim to deliver outstanding results.
            </p>
            <div className='text-lg font-bold'>
              <p>Find me on:</p>
              <div className='mb-8 text-4xl flex gap-5'>
                <Link
                  to='https://www.linkedin.com/in/jrfu/'
        ...
        <div className='container mx-auto'>
          <div className=' text-center py-12'>
            ...
            <p className='max-w-xl mx-auto text-lg'>
              Explore my comprehensive portfolio of web projects, ranging from
              dynamic websites to interactive web applications.
            </p>
          </div>
        ...
        <div className='container mx-auto'>
          ...
          <div className='text-black py-12 grid lg:grid-cols-4 items-center'>
            <div>
              ...
              <h3 className='text-3xl font-bold mb-4'>Website Development</h3>
              ...
              <h3 className='text-3xl font-bold mb-4'>Web application Development</h3>
              <p className='mb-14 text-lg'>
              Offering web application development, create web applications that seamlessly interact with diverse data sources and services. 
              </p>
